...
<body>
  <section id="container">
    ...
    <header class="header bg-bg">
      ...
      <!--logo start-->
      <a href="index.php" class="logo"><b>DKSTORE<span> ADMIN</span></b></a>
      <div class="top-menu">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="grids.php">All Users</a></li>
              <li><a href="grids.php">Manager Users</a></li>
              <li><a href="grids.php">Customer Users</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
            ...
            <ul class="sub">
              <li><a href="blank.php">All Products</a></li>
              <li><a href="login.php">Public Products</a></li>
              <li><a href="lock_screen.php">primary Products</a></li>
              <li><a href="lock_screen.php">Products Sold out</a></li>
            </ul>
          </li>
      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-9 main-chart">
            ...
            <form action="#" method="get">
              <div class="border-head">
                <div class="col-lg-2"><h3>Doanh Thu</h3></div>
                <div class="col-lg-5"></div>
                <div class="col-lg-5">
                  <input type="text" maxlength="4" size="11" class="btn btn-themevip" name="year" placeholder="Years"/>
                  <select class="btn btn-themevip" name="month">
                  ...
                  <button type="submit" name="button" class="btn btn-themevip">
                    Expost <span class="fa fa-filter"></span>
                  </button>
                </div>
              </div>
            </form>
            <div class="custom-bar-chart">
              ...
              <div class="bar">
                ...
                <div class="value tooltips" data-original-title="8.500" data-toggle="tooltip" data-placement="top">10%</div>
              </div>
              <div class="bar ">
              ...
              <div class="col-md-4 col-sm-4 mb">
                <div class="darkblue-panel pn">
                  <div class="darkblue-header">
                    <h5>Doanh thu theo hãng</h5>
                  </div>
                  <canvas id="doughnut" height="120" width="120"></canvas>
                  <script>
                    var doughnutData = [{
                        value: 60,
                        color: "#1c9ca7"
          ...
          <div class="col-lg-3 ds">
            ...
            <h4 class="centered mt">Đơn hàng vừa thanh toán</h4>
            <!-- First Activity -->
            <div class="desc">
              <div class="thumb">
              ...
              <div class="details">
                <p>
                  ...
                  <br/>
                  <a href="#">Phan Đại</a> vừa thanh toán đơn hàng <a href="?id=0000">DK - STORE 00001</a>.<br/>
                </p>
              </div>
            </div>
            <!-- Second Activity -->
