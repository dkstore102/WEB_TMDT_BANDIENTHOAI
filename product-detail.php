			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="<?php echo $_SESSION['number_cart']; ?>">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<?php
									$id =$_REQUEST['IP'];
									$read->readProductDetail_title("https://dk-store102.tk/php/api/exportProductsDetail.php?IP=$id");
								?>
									...
									<div class="size-204 respon6-next">
										<div class="rs1-select2 bor8 bg0">
											<select class="js-select2" name="cauhinh">
												<option value="">Choose an configuration system</option>
												<?php
													$id =$_REQUEST['IP'];
													$read->readExportsystem("https://dk-store102.tk/php/api/exportsystem.php?IP=$id");
												?>
											</select>
									...
									<div class="size-204 respon6-next">
										<div class="rs1-select2 bor8 bg0">
											<select class="js-select2" name="mau">
												<option value=""i>Choose an color</option>
												<?php
													$id =$_REQUEST['IP'];
													$read->readExportColor("https://dk-store102.tk/php/api/exportcolor.php?IP=$id");
												?>
											</select>
											<div class="dropDownSelect2"></div>
										</div>
									...
									<div class="p-b-30 m-lr-15-sm">
										...
										<form class="w-full">
											...
											<?php
														...
														case 'add':
															{
																...
																$id_mau = $_REQUEST['mau'];
																$p->Interactive("INSERT INTO `giohang` (`ID_ND`, `ID_CTSP`, `SoLuong`) VALUES ('1',(select ID_CTSP from chitietsanpham where ID_SP = $id && ID_Mau = $id_mau && ID_CauHinh = $id_cauhinh), $soluong)");
												...
												}else if($_REQUEST['mau'] == '' && $_REQUEST['cauhinh'] =='' && isset($_REQUEST['mau']) && isset($_REQUEST['cauhinh'])){
													echo'<script>alert ("you need to choose Color and System!!!"); window.location.reload(); </script>';
												}
											?>
										</form>
									</div>
